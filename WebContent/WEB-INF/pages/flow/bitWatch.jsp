...
%>	
<br>
    <font face="Arial" size="+1" color=#000000 text-align="center"><CENTER>比   特  统 计 图</CENTER></font>
    <CENTER>
    <FORM action="bitWatch.do?toview=1" method=post name=submitView>
选择视图
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
    ...
    <b>比特流量图</b> | <a href="packetWatch.do?submitView=<%= sv %>">分组流量图</a> | <a href="lenWatch.do?submitView=<%= sv %>">包长统计图</a> | <a href="flowEventStatus.do?submitView=<%= sv %>">汇总监测图</a> | <a href="FlowStatisticQuery.do">流量统计</a> 
  </tr>
</table>
</CENTER>
<br>
				...
				<s:iterator value="FlowEvent" id="tmp"> 
					...
					<s:form name="myform">
						<s:iterator value="#tmp.value" status="tmptable"> 
							<div id="view">
					        	<a href="javascript:dobit('<s:property value='ip'/>','<s:property value='inf'/>')"><img src="<s:property value='pic1'/>"/></a><br>
					        </div>
				        </s:iterator>
					</s:form>
				</s:iterator>
