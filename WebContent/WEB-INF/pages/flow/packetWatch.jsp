...
%>
<br>
    <font face="Arial" size="+1" color=#000000 text-align="center"><CENTER>分 组 流 量 图</CENTER></font>
    <CENTER>
    <FORM action="packetWatch.do?toview=1" method=post name=submitView>
选择视图
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
    ...
    <a href="bitWatch.do?submitView=<%= sv %>">比特流量图</a> | <b>分组流量图</b> | <a href="lenWatch.do?submitView=<%= sv %>">包长统计图</a> | <a href="flowEventStatus.do?submitView=<%= sv %>">汇总监测图</a> | <a href="FlowStatisticQuery.do">流量统计</a> 
  </tr>
</table>
</CENTER>
<br>
		...
		<div id="infoDiv">
			...
			<div id="eventListDiv">
					...
					<s:form name="myform">
										...
										<div id="view">
								        		<a href="javascript:dopkt('<s:property value='ip'/>','<s:property value='inf'/>')"><img src="<s:property value='pic2'/>"/></a><br>
								        </div>
								        </s:iterator>
					</s:form>
						</s:iterator>
