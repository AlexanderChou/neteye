...
<head>
	<!-- 
		此页面不前不用了
	 -->
	<title><s:text name='show.showSwitchBindingTable.title'/></title>
	<link rel='StyleSheet' href="css/savitopoInit.css" type="text/css" />
	<link rel="stylesheet" type="text/css" href="css/ext-all.css" />
	<script type="text/javascript" src="js/ext-base.js"></script>
	<script type="text/javascript" src="js/ext-all.js"></script>
	<script type="text/javascript" src="js/show/showSwitchBindingTable.js"></script>
	<script type="text/javascript">
		...
		var bUserNameText = "<s:text name='bindingTable.userName'/>";
		...
		var bindingTableForSwitchText = "<s:text name='show.showSwitchBindingTable.bindingTableForSwitch'/>";
