...
<html>
<head>
	<title><s:text name='show.showSearchResults.title'/></title>
	...
	<script type="text/javascript" src="js/show/showSearchResults.js"></script>
	...
	<SCRIPT type="text/javascript">
		...
		var subnetListText = "<s:text name='show.showSearchResults.subnetList'/>";
		var saviSystemTableText = "<s:text name='show.showSearchResults.saviSystemTable'/>";
		var switchbasicInfoText = "<s:text name='show.showSearchResults.switchbasicInfo'/>";
		var searchResultsText = "<s:text name='show.showSearchResults.searchResults'/>";
	</script>
</head>
