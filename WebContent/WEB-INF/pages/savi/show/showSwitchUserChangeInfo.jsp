...
<html>
<head>
	<title><s:text name='show.showSwitchUserChange.title'/></title>
	<link rel='StyleSheet' href="css/savitopoInit.css" type="text/css" />
	<link rel="stylesheet" type="text/css" href="css/ext-all.css" />
	<script type="text/javascript" src="js/ext-base.js"></script>
	<script type="text/javascript" src="js/ext-all.js"></script>
	<script type="text/javascript" src="js/show/showSwitchUserChangeInfo.js"></script>
	<script type="text/javascript">
		...
		var userChangeInfoText = "<s:text name='show.showSwitchUserChange.userChangeInfo'/>";
	</script>
</head>
<body>
