...
<html>
<head>
	<title><s:text name='show.showRealTimeInterfaceBindingTableInfo.title'/></title>
	<link rel='StyleSheet' href="css/savitopoInit.css" type="text/css" />
	<link rel="stylesheet" type="text/css" href="css/ext-all.css" />
	<script type="text/javascript" src="js/ext-base.js"></script>
	<script type="text/javascript" src="js/ext-all.js"></script>
	<script type="text/javascript" src="js/show/showRealTimeInterfaceBindingTableInfo.js"></script>
	<script type="text/javascript">
		...
		var bindingTableForInterfaceText = "<s:text name='show.showRealTimeInterfaceBindingTableInfo.bindingTableForInterface'/>";
		var switchText = "<s:text name='show.showRealTimeInterfaceBindingTableInfo.switch'/>";
		var indexText = "<s:text name='show.showRealTimeInterfaceBindingTableInfo.index'/>";
		var showStaticText = "<s:text name='show.showRealTimeInterfaceBindingTableInfo.showStatic'/>";
		var showSlaacText = "<s:text name='show.showRealTimeInterfaceBindingTableInfo.showSlaac'/>";
		var showDhcpText = "<s:text name='show.showRealTimeInterfaceBindingTableInfo.showDhcp'/>";
		var showAllText = "<s:text name='show.showRealTimeInterfaceBindingTableInfo.showAll'/>";
		</script>
</head>
<body>
	<div id="bodyDiv">
