...
Ext.onReady(function() {
	...
	var DelayXmlStore = new Ext.data.Store({
				proxy : new Ext.data.HttpProxy({
							url : 'json/getallv6ReorderingXML.do'
						}),
...
<tr>
<td><div id="header1"><a href="IPv6Reachability.do" style="text-decoration:none;">可达性</a></div></td>
<td><div id="header2"><a href="IPv6performanceTask.do" style="text-decoration:none;">延时</a></div></td>
<td><div id="header3"><a href="IPv6Loss.do" style="text-decoration:none;">丢包</a></div></td>
<td><div id="header4"><a href="IPv6Reordering.do" style="text-decoration:none;">乱序</a></div></td>
</tr>
</table>
<div id="outer">
		<div id="bodyDiv">
