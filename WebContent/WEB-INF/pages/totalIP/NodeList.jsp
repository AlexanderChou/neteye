...
<title>IP地址统计的节点列表</title>
	...
	<script type="text/javascript" src="js/totalIP_render.js"></script>
	<script type="text/javascript" src="js/totalIP_list.js"></script>
</head>
<body>

<div id="bodyDiv" class="align-center">
		<div id="infoDiv">
				<div id='showTotalDiv'></div>
				<div id='showHourDiv'></div>
				<div id='showDayDiv'></div>
