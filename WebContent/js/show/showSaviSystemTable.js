...
Ext.onReady( function() {
	...
	var proxy = new Ext.data.HttpProxy( {
		url : ids=="" ? "show/listSaviTable.do?subnetId="+subnetId : "show/batchGetSavi.do?ids=" + ids
	});
	...
	var grid = new Ext.grid.GridPanel( {
		...
		tbar : [ '->','-','->', {
			...
			handler: function(){
				...
				document.location.href = 'showSwitches.do?ids='+sIds+'&subnetId='+subnetId;;
			}},'->','-'
		]
	});
