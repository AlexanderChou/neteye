...
public class TotalHistoryTtlAction extends ActionSupport{
	...
	public String execute() throws Exception{
		...
		totalResult = bpo.createTotalHistoryResult("ttl", dir+File.separator+fileName,"Packet Number","ttlnum","value");
		return SUCCESS;
	}

   public static void main(String[] args) throws Exception {
	   	TotalHistoryTtlAction test = new TotalHistoryTtlAction();
	   	test.execute();
   }
