...
public class TopNHistoryProtocolAction extends ActionSupport{
	...
	public String execute() throws Exception{
		...
		totalResult = bpo.createHistoryResult("topnprotocol", dir+File.separator+fileName,"MB");
		return SUCCESS;
	}

   public static void main(String[] args) throws Exception {
	   	TopNHistoryProtocolAction test = new TopNHistoryProtocolAction();
	   	test.execute();
   }
