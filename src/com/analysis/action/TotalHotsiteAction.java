...
public class TotalHotsiteAction extends ActionSupport{
	...
	public String execute() throws Exception{
		...
		totalResult = bpo.createTotalResult("hotsite", dir+File.separator+fileName,"Packet Number","ipaddr","value");
		return SUCCESS;
	}

   public static void main(String[] args) throws Exception {
	   	TotalHotsiteAction test = new TotalHotsiteAction();
	   	test.execute();
   }
