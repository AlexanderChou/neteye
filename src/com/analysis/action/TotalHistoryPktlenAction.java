...
public class TotalHistoryPktlenAction extends ActionSupport{
	...
	public String execute() throws Exception{
		...
		totalResult = bpo.createTotalHistoryResult("pktlen", dir+File.separator+fileName,"Packet Number","pktlennum","value");
		return SUCCESS;
	}

   public static void main(String[] args) throws Exception {
	   	TotalHistoryPktlenAction test = new TotalHistoryPktlenAction();
	   	test.execute();
   }
