...
public class TopNUserPortAction extends ActionSupport{
	...
	public String execute() throws Exception{
		...
		totalResult = bpo.createResult("topnport", dir+File.separator+fileName,"MB");
		return SUCCESS;
	}

   public static void main(String[] args) throws Exception {
	   	TopNUserPortAction test = new TopNUserPortAction();
	   	test.execute();
   }
