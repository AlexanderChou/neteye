...
public class TotalHistoryPortAction extends ActionSupport{
	...
	public String execute() throws Exception{
		...
		totalResult = bpo.createTotalHistoryResult("portstat", dir+File.separator+fileName,"M","portnum","value");
		return SUCCESS;
	}

   public static void main(String[] args) throws Exception {
	   	TotalHistoryPortAction test = new TotalHistoryPortAction();
	   	test.execute();
   }
