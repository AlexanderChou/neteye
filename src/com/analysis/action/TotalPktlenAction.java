...
public class TotalPktlenAction extends ActionSupport{
	...
	public String execute() throws Exception{
		...
		totalResult = bpo.createTotalResult("pktlen", dir+File.separator+fileName,"Packet Number","pktlennum","value");
		return SUCCESS;
	}

   public static void main(String[] args) throws Exception {
	   	TotalPktlenAction test = new TotalPktlenAction();
	   	test.execute();
   }
