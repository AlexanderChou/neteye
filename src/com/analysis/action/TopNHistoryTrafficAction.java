...
public class TopNHistoryTrafficAction extends ActionSupport{
	...
	public String execute() throws Exception{
		...
		totalResult = bpo.createHistoryResult("topntraffic", dir+File.separator+fileName,"MB");
		return SUCCESS;
	}

   public static void main(String[] args) throws Exception {
	   	TopNHistoryTrafficAction test = new TopNHistoryTrafficAction();
	   	test.execute();
   }
