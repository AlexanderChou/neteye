...
public class TotalPortAction extends ActionSupport{
	...
	public String execute() throws Exception{
		...
		totalResult = bpo.createTotalResult("portstat", dir+File.separator+fileName,"M","portnum","value");
		return SUCCESS;
	}

   public static void main(String[] args) throws Exception {
	   	TotalPortAction test = new TotalPortAction();
	   	test.execute();
   }
