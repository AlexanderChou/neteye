...
public class TotalHistoryHotsiteAction extends ActionSupport{
	...
	public String execute() throws Exception{
		...
		totalResult = bpo.createTotalHistoryResult("hotsite", dir+File.separator+fileName,"Packet Number","ipaddr","value");
		return SUCCESS;
	}

   public static void main(String[] args) throws Exception {
	   	TotalHistoryHotsiteAction test = new TotalHistoryHotsiteAction();
	   	test.execute();
   }
