...
public class TotalProtocolAction extends ActionSupport{
	...
	public String execute() throws Exception{
		...
		totalResult = bpo.createTotalResult("protocolstat", dir+File.separator+fileName,"M","protocolnum","value");
		return SUCCESS;
	}

   public static void main(String[] args) throws Exception {
	   	TotalProtocolAction test = new TotalProtocolAction();
	   	test.execute();
   }
