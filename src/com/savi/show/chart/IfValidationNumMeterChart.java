...
*/
public class IfValidationNumMeterChart{
	private static IfInterfaceDao ifInterfaceDao = new IfInterfaceDao();
	private Long switchId;
	
	public IfValidationNumMeterChart(Long switchId) {
	...
	public void createChart(Integer ipVersion, Long switchbasicinfoId,String label) {	
		Long ifValiationnum = ifInterfaceDao.getInterfaceValidationNum(switchId);
		generateMaxFilteringNumPic(ifValiationnum.toString(),ipVersion, switchbasicinfoId,label);
	}
	...
	public void generateMaxFilteringNumPic(String val,Integer ipVersion, Long switchbasicinfoId,String label) {
		try {
			...
			FileOutputStream fos = new FileOutputStream(path + "IfValidation_" + ipVersion + "_" + switchbasicinfoId + ".png");
