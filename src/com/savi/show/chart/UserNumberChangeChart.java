...
*/
public class UserNumberChangeChart{
	private SavibindingtableDao savibindingtableDao = new SavibindingtableDao();
	private Long subnetId;
	
	public UserNumberChangeChart(Long subnetId) {
...
private XYDataset createDataset(Long subnetId) {
    ...
    List list = savibindingtableDao.getOnlineTimeUsers(subnetId);
    int pretime = 0;
    boolean preday = true;
