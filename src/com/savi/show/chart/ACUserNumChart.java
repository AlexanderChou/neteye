...
*/
public class ACUserNumChart {
	private DeviceDao deviceDao = new DeviceDao();
	private Long acId;
	
	public ACUserNumChart(Long acId) {
		this.acId = acId;
	}
	...
	private CategoryDataset createDataset(Long acId) {
		List list = deviceDao.getACUserNum(acId);
	...
	public JFreeChart createChart() {
		CategoryDataset dataset = createDataset(acId);
		// create the chart...
