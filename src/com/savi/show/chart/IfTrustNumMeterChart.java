...
*/
public class IfTrustNumMeterChart{
	private static IfInterfaceDao ifInterfaceDao = new IfInterfaceDao();
	private Long switchId;
	
	public IfTrustNumMeterChart(Long switchId) {
	...
	public void createChart(Integer ipVersion, Long switchbasicinfoId,String label) {	
		Long iftrustnum = ifInterfaceDao.getInterfaceTrustNum(switchId);
		generateMaxFilteringNumPic(iftrustnum.toString(),ipVersion,switchbasicinfoId,label);
	}
	...
	public void generateMaxFilteringNumPic(String val,Integer ipVersion, Long switchbasicinfoId,String label) {
		try {
			...
			FileOutputStream fos = new FileOutputStream(path + "IfTrust_" + ipVersion + "_" + switchbasicinfoId + ".png");
			...
			Font f1 = new Font("Dialog", Font.PLAIN, 11);
			g.setFont(f1);
