...
*/
public class FilteringTableRecordNumChart1  {
	private static SavibindingtableDao bindingDao = new SavibindingtableDao();
	private Long switchId;
	
	public FilteringTableRecordNumChart1(Long switchId) {
	...
	public void createChart(Integer ipVersion, Long switchbasicinfoId,String label) {	
		Long maxfilternum = bindingDao.getInterfaceFilteringNum(switchId);
		generateMaxFilteringNumPic(maxfilternum.toString(),ipVersion,switchbasicinfoId,label);
	}
	...
	public void generateMaxFilteringNumPic(String val,Integer ipVersion, Long switchbasicinfoId,String label) {
		try {
			...
			FileOutputStream fos = new FileOutputStream(path + "Filtering_" + ipVersion + "_" + switchbasicinfoId + ".png");
