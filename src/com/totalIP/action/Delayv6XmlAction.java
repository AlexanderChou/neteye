...
import com.totalIP.dao.DelayDaov6;
import com.totalIP.dto.NodeDelayshow;
import com.totalIP.dto.XMLOb;

public class Delayv6XmlAction extends ActionSupport{
	...
	public String eighthoursdelayxml() {
		Date date = new Date();
		...
		root.setAttribute("caption", "Delay in recent 8 hours");
		...
		for(int i = 0; i <= 7; i++){
			...
			List<NodeDelayshow> nds = dd.getRecentEightHoursDelay();
			Element setElement = document.createElement("set");
			setElement.setAttribute("value", ""+nds.get(5*i+1).getRtt());
		...
		for(int i = 0; i <= 7; i++){
			...
			List<NodeDelayshow> nds = dd.getRecentEightHoursDelay();
			Element setElement = document.createElement("set");
			setElement.setAttribute("value", ""+nds.get(5*i+2).getRtt());
		...
		for(int i = 0; i <= 7; i++){
			...
			List<NodeDelayshow> nds = dd.getRecentEightHoursDelay();
			Element setElement = document.createElement("set");
			setElement.setAttribute("value", ""+nds.get(5*i+3).getRtt());
		...
		for(int i = 0; i <= 7; i++){
			...
			List<NodeDelayshow> nds = dd.getRecentEightHoursDelay();
			Element setElement = document.createElement("set");
			setElement.setAttribute("value", ""+nds.get(5*i+4).getRtt());
	...
	public String onedaydelayxml() {
		...
		//创建根节点
		Element root = document.createElement("chart");
		root.setAttribute("caption", "Delay in recent one day");
		...
		for(int i = 0; i < 24; i++){
			DelayDaov6 dd = new DelayDaov6();
			List<NodeDelayshow> nds = dd.getRecentOneDayDelay();
			Element setElement = document.createElement("set");
			setElement.setAttribute("value", ""+nds.get(5*i).getRtt());
			afrnicdatasetElement.appendChild(setElement);
		}
	...
	public String oneweekdelayxml() {
		...
		//创建根节点
		Element root = document.createElement("chart");
		root.setAttribute("caption", "Delay in recent one week");
		root.setAttribute("subcaption", "(From "+onedayagodoc+" to "+doc+")");
		root.setAttribute("lineThickness", "1");
		root.setAttribute("showValues", "0");
		root.setAttribute("formatNumberScale", "0");
		...
		for(int i = 0; i < 7; i++){
			DelayDaov6 dd = new DelayDaov6();
			List<NodeDelayshow> nds = dd.getRecentOneWeekDelay();
			Element setElement = document.createElement("set");
			setElement.setAttribute("value", ""+nds.get(5*i).getRtt());
			afrnicdatasetElement.appendChild(setElement);
		}
	...
	public String alldelayxml() {
		Delayv6XmlAction d = new Delayv6XmlAction();
		XMLOb a = new XMLOb();
		a.setEighthoursxmlName(d.eighthoursdelayxml());
		System.out.println("11");
		a.setOnedayxmlName(d.onedaydelayxml());
		System.out.println("22");
		a.setOneweekxmlName(d.oneweekdelayxml());
