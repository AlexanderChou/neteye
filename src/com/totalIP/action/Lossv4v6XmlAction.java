...
public class Lossv4v6XmlAction extends ActionSupport{
	...
	public String eighthourslossxml(){
		...
		for(int i = 0; i <= 7; i++){
			...
			List<NodeLossshow> nds = dd.getRecentEightHoursLoss();
			Element setElement = document.createElement("set");
			setElement.setAttribute("value", ""+nds.get(2*i+1).getLoss());
	...
	public String alllossxml() {
		Lossv4v6XmlAction d = new Lossv4v6XmlAction();
		XMLOb a = new XMLOb();
