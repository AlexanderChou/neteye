 ...
 *
 */
public class TrafficeMatrixInfoAction extends ActionSupport{
	 ...
	 * @return
	 */
	public String queryTrafficMatrixInfo(){
		System.setProperty("javax.xml.parsers.DocumentBuilderFactory","com.sun.org.apache.xerces.internal.jaxp.DocumentBuilderFactoryImpl");
		String fileName = "tm.xml";
		...
		try {
			...
			File dir=new File(Constants.webRealPath+"file/netflow/downLoadFile/");
				...
				File f = new File(Constants.webRealPath+"file/netflow/downLoadFile/tm.xml");
	...
	public String viewHistory(){
		try{
		   ...
		   url = (String) call.invoke( new Object[] {"node",row,col} );
