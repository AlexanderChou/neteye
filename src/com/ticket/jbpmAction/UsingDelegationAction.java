...
public class UsingDelegationAction  implements ActionHandler {
	...
	public void execute(ExecutionContext context) throws Exception {
		...
		if(ticket != null){
				...
				if(ticket.getStatus()==TicketState.ACCEPT_PUB_AND_WAIT_DEALING || ticket.getStatus()==TicketState.DELEGATING_DISACCEPT ||ticket.getStatus()==TicketState.TICKET_UNPASS){
					ticket.setStatus(TicketState.BEING_DELEGATE);	
